...
if [ ! -f "/debug_service_1.txt" ]; then
    ...
    # Give the client half an hour to download both the encrypted user password file and the S3 encryption key from the FTPS server before taking them offline
    sleep 1800
    mkdir "/root/archives/"
    ...
    if [ ! -f "/home/humungous/humungous_private.asc" ]; then
        ...
        if [ -f "/home/humungous/.aws/credentials" ]; then
            ...
            su - -c "/usr/local/bin/aws iam create-access-key --user-name S3PrivilegedScriptUploader" humungous > "/home/humungous/aws_token_storage/s3privilegedscriptuploader_access_key.json"
            ...
            echo "[default]" > "/home/humungous/.aws/credentials_2"
            echo "aws_access_key_id = $(cat /home/humungous/aws_token_storage/s3privilegedscriptuploader_access_key.json | jq --raw-output '.AccessKey.AccessKeyId')" >> "/home/humungous/.aws/credentials_2"
            echo "aws_secret_access_key = $(cat /home/humungous/aws_token_storage/s3privilegedscriptuploader_access_key.json | jq --raw-output '.AccessKey.SecretAccessKey')" >> "/home/humungous/.aws/credentials_2"
            ...
            chown root:root "/home/humungous/.aws/credentials"
            chmod 600 "/home/humungous/.aws/credentials"
            mv "/home/humungous/.aws/credentials_2" "/home/privileged-script-manager/.aws/credentials"
            chown privileged-script-manager:privileged-script-manager "/home/privileged-script-manager/.aws/credentials"
            chmod 600 "/home/privileged-script-manager/.aws/credentials"
